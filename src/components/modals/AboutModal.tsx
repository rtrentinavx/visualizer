        ...
        <div className="flex-1 overflow-auto p-4 space-y-4 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-xs">
              ...
              <li><strong>AI Assist</strong> — Policy explanation, evaluator fix suggestions, reachability analysis, and free-form chat with conversation memory via OpenAI, Anthropic, Google, Ollama, LM Studio, or AWS Bedrock</li>
              <li><strong>Export</strong> — Terraform (Aviatrix provider), CSV flows</li>
              <li><strong>Import</strong> — Terraform HCL paste or zip (aviatrix_smart_group + aviatrix_dcf_policy_list), FortiGate .conf or XML, Palo Alto PAN-OS running-config XML (vsys + Panorama device-group/shared), or live fetch from Aviatrix Controller via REST API or MCP</li>
            </ul>
          </div>
          <div>
